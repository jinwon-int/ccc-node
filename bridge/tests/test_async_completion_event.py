...
def test_stable_body_free_identity() -> None:
    ...
    assert event.identity_hash == "09c8dd9541aae9ad7ba6d193d3496d0bf4a7a265f9e7a73202d8aa8d04fe03ec"
    assert event.idempotency_key == f"async-completion:{event.identity_hash}"

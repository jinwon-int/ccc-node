"""Bounded Danso subprocess adapter.

Imported from jinwon-int/danso dac88d49 integrations/ccc_node.py.
Telegram composition and configuration live in danso_runtime.py.
"""
import asyncio
import json
import os
...
class DansoRuntime:
    ...
    def __init__(self, *, binary, state_directory, provider, model, environment,
                 timeout_seconds=300, provider_timeout_seconds=180, max_turns=16, compact_at_bytes=None, sandbox="host", system_context_loader=None):

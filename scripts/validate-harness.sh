...
for t in claude/hooks/guard.test.sh claude/hooks/observability.test.sh claude/hooks/security-scan.test.sh \
         ...
         claude/hooks/distill/extract.test.sh claude/hooks/distill/honcho-push.test.sh claude/hooks/distill/wiki-queue.test.sh \
         claude/hooks/distill/queue-drain.test.sh \

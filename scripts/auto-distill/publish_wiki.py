...
_E = r"(?![A-Za-z0-9_])"
TOKEN_RE = re.compile(
    '(-----BEGIN [A-Z ]*PRIVATE KEY-----|github_pat_[A-Za-z0-9_]{20,}|(?<![A-Za-z0-9_])(?:ghp|gho|ghu|ghs|ghr)_[A-Za-z0-9_]{20,}|(?<![A-Za-z0-9_])sk-[A-Za-z0-9_-]{32,}|(?<![A-Za-z0-9_])AKIA[0-9A-Z]{16}(?![A-Za-z0-9_])|(?<![A-Za-z0-9_])AIza[0-9A-Za-z_-]{30,}|(?<![A-Za-z0-9_])xox[baprs]-[0-9A-Za-z-]{20,}|(?<![A-Za-z0-9_])[0-9]{8,10}:(?![a-f0-9]{30,}(?![A-Za-z0-9_-]))[A-Za-z0-9_-]{30,}|tskey-[a-z]+-[A-Za-z0-9]{10,}|glpat-[A-Za-z0-9_-]{20,}|(?<![A-Za-z0-9_])hf_[A-Za-z0-9]{30,}|(?<![A-Za-z0-9_])npm_[A-Za-z0-9]{36,}|(?<![A-Za-z0-9_])dop_v1_[A-Fa-f0-9]{64,}|(?<![A-Za-z0-9_])SG\\.[A-Za-z0-9_-]{16,}\\.[A-Za-z0-9_-]{16,}|AGE-SECRET-KEY-1[A-Z0-9]{20,}|hooks\\.slack\\.com/services/[A-Za-z0-9/_+-]{20,}|(?<![A-Za-z0-9_])eyJ[A-Za-z0-9_-]{10,}\\.eyJ[A-Za-z0-9_-]{10,}\\.|[a-z][a-z0-9+.-]*://[^/\\s:@]+:[^/\\s@]+@|(?<![A-Za-z0-9_])(?:apikey|api_key|apitoken|api_token|secret_key|access_token)_[A-Za-z0-9][A-Za-z0-9_]{31,}|(?<![A-Za-z0-9_])01[016789][-. ]?[0-9]{3,4}[-. ]?[0-9]{4}(?![A-Za-z0-9_]))'
)

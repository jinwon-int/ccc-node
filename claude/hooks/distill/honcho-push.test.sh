...
ok "success invalidates the next Honcho refresh" '[ -s "$INVALIDATE" ]'
...
ok "health failure does not invalidate a successful read cache" '[ ! -e "$INVALIDATE" ]'
...
ok "failed push does not invalidate a successful read cache" '[ ! -e "$INVALIDATE" ]'

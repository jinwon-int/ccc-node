...
run_scan_case "$HK" CCC_MEMORY_SCAN_PARALLEL=0; serial_out="$scan_out"
ok "scan: forced-serial path marks no parallel stage" '! took_parallel'
run_scan_case "$HK" CCC_MEMORY_SCAN_PARALLEL=1; parallel_out="$scan_out"
...
run_scan_case "$HK" CCC_MEMORY_SCAN_MIN_CORES=1; low_out="$scan_out"
ok "scan: min-cores=1 opts this node into the parallel path" 'took_parallel'
run_scan_case "$HK" CCC_MEMORY_SCAN_MIN_CORES=99; high_out="$scan_out"
...
run_scan_case "$HK" CCC_MEMORY_SCAN_PARALLEL=0 CCC_MEMORY_SCAN_MIN_CORES=1; off_out="$scan_out"
ok "scan: explicit =0 overrides a permissive min-cores" '! took_parallel && [ "$off_out" = "$serial_out" ]'
run_scan_case "$HK" CCC_MEMORY_SCAN_MIN_CORES=abc; junk_out="$scan_out"
...
run_scan_case "$noscan" CCC_MEMORY_SCAN_PARALLEL=0; fo_serial="$scan_out"
run_scan_case "$noscan" CCC_MEMORY_SCAN_PARALLEL=1; fo_parallel="$scan_out"

#!/usr/bin/env bash
# Hermetic tests for the web-routing helpers: Firecrawl search/fetch/developer
# calls and explicit SearXNG fallback. No network beyond loopback.
# Byte-identical to piri/skills/web/web_tools.test.sh except this header —
# keep functional changes in sync across the two lanes.
set -uo pipefail
